-- ============================================
-- SCHEMA COMPLETO PARA COPILOTO UBER
-- Ejecutar TODO en el SQL Editor de Supabase
-- ============================================

-- ============================================
-- 1. TABLA: settings (configuración general)
-- ============================================
...
-- ============================================
-- 2. TABLA: events (eventos: ingresos, gastos, pausas)
-- ============================================
...
-- ============================================
-- 3. ÍNDICES (para mejorar performance de queries)
-- ============================================
...
-- ============================================
-- 5. DATOS INICIALES: Insertar settings por defecto
-- ============================================
...
-- ============================================
-- NOTA IMPORTANTE SOBRE RLS (Row Level Security)
-- ============================================
-- Como usas service_role en el backend, NO necesitas
-- habilitar RLS. El service_role bypassa todas las políticas.
-- Si quieres habilitarlo de todas formas (opcional):
